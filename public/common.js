...
var autoplay = document.getElementsById("Carousal_container").getAttribute("data-autoplay");
var l = slide.length;
var interval = 5000;
var set;
window.onload = function () {
    ...
    for (var j = 0; j < l; j++) {
        indicator.innerHTML += "<div className='dots' ref={this.dots} onClick={change(" + j + ")}></div>";
    }
